...
public class BodyCreator {
    ...
    public static Body createBody(float x, float y, float width, float height, boolean isStatic, World world) {
        ...
        vertices[0] = new Vector2((float) (-width / 2 + 0.6 * GameSettings.BLOCK_SIDE * GameSettings.OBJECT_SCALE), -height/2);
        vertices[1] = new Vector2((float) (width / 2 - 0.6 * GameSettings.BLOCK_SIDE * GameSettings.OBJECT_SCALE), -height/2);
